...
For users reliant on IDE help, (and who isn't), theme() is quite unhelpful. For example the RStudio IDE will tell you all the theme elements, but what do you do from there? Once you selected your theme element, e.g. you've got 'theme(strip.text.y.left = )' the IDE gives you no more help.  
